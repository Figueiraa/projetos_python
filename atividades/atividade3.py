def dimensoesObjetos(): #função para receber as medidas do objeto e calcular o volume dele
    while True: #laço de repetição infinito
        try:
            ...
            comprimentoObjeto = float(input('Digite o comprimento do objeto (em cm): ')) #entrada do comprimento do objeto
...
print('Total a pagar(R$): {} (dimensões: {} * peso: {} * rota: {})'.format(valorFinal,dimensoes,peso,rota)) #print do valor e do calculo pro usuario